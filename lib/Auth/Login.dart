...
import 'package:my_doctor/other/openFile.dart';
...
class _LoginState extends State<Login>
{
    ...
    userLogin()async
    {
        ...
        {
            Fluttertoast.showToast(msg:'vui long nh?p email và m?t kh?u');
        }else
        {
            try
            {
                ...
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => const OpenGallery()));
            }  catch (e)
            {
        ...
        Row(
            ...
            children: [
                ...
                InkWell(
                    ...
                    child: const Text("Signup", style: TextStyle(color: Colors.red,fontSize: 15))
                )
            ]
        );
    }
